   ...
   <xsl:template name="make-html-header">
    <head>
      ...
      <title>
        ...
        <xsl:value-of
          select="string(/article/front/article-meta/title-group/article-title[1])"/>
      </title>
...
<!-- ============================================================= -->
  ...
  <xsl:template match="book-series-meta">
    <div style="background-color:lightblue;">
      ...
      <p style="margin-bottom:10pt;">
        <span style="color:blue;">Book-Series: </span>
        <xsl:apply-templates/>
      </p>
    </div>
  </xsl:template>
  ...
  <xsl:template match="book-meta">
    <div style="background-color:lightblue;">
      <p style="margin-bottom:10pt;">
        <span style="color:blue;">Book-DOI: </span>
        <xsl:apply-templates select="book-id"/>
      </p>
      <p style="margin-bottom:10pt;">
  ...
  <xsl:template match="book-part-meta/book-part-id">
    <div style="background-color:lightblue;">
      <p style="margin-bottom:10pt;">
      <span style="color:blue;">Chapter-DOI: </span>
      <xsl:apply-templates/>
    </p>
    <hr/>
    <p>
    ...
    <xsl:for-each select="//sec/title">
      <p>
        <xsl:if test="count(ancestor::sec)=1">
          <xsl:attribute name="style"> text-transform: uppercase;color:darkblue;font-weight:bold;</xsl:attribute>
        </xsl:if>
        <xsl:if test="count(ancestor::sec)=2">
          <xsl:attribute name="style">color:#0B610B;text-indent:12pt;font-weight:bold;</xsl:attribute>
        </xsl:if>
        <xsl:if test="count(ancestor::sec)=3">
          <xsl:attribute name="style">color:#B45F04;text-indent:24pt;font-style:italic;font-weight:bold;</xsl:attribute>
        </xsl:if>
        <xsl:if test="count(ancestor::sec)=4">
          <xsl:attribute name="style">text-indent:36pt;</xsl:attribute>
        </xsl:if>
        <xsl:if test="count(ancestor::sec)=5">
          <xsl:attribute name="style">text-indent:48pt;</xsl:attribute>
        </xsl:if>
        <xsl:if test="count(ancestor::sec)=6">
          <xsl:attribute name="style">text-indent:60pt;</xsl:attribute>
        </xsl:if>
        <xsl:apply-templates/>
      </p>
    </xsl:for-each>
    ...
    <table style="border: 1px solid black;margin-top:33pt;" width="33%">
      <thead>
        <tr>
          <th style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em; font-weight: bold;" colspan="3" align="left">Figure Links</th>
        </tr>
      </thead>
      <tbody>
        <xsl:for-each select="//fig">
          <xsl:if test="boolean(./@id)">
            <tr>
                <xsl:variable name="figId" select="string(./@id)"/>
                <xsl:if test="boolean(ancestor::book-part-wrapper/descendant::xref/@rid=$figId)">
                  <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                    <span style="color:blue;">
                      <xsl:value-of select="$figId"/>
                    </span>
                  </td>
                  <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                    <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span><xsl:value-of select="string(ancestor::book-part-wrapper/descendant::xref[@rid=$figId])"/>
                    <br/>
                    <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span><xsl:value-of select="string(child::label)"/>
                  </td>
                </xsl:if>
                <xsl:if test="not(ancestor::book-part-wrapper/descendant::xref/@rid=$figId)">
                  <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  ...
                  <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                    <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                    <xsl:value-of select="string(ancestor::book-part-wrapper/descendant::xref[@rid=$figId])"/>
                    <br/>
                    <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                    <xsl:value-of select="string(child::label)"/>
                  </td>
                </xsl:if>
            </tr>
          </xsl:if>
    ...
    <table style="border: 1px solid black;margin-top:24pt;" width="33%">
      <thead>
        <tr>
          <th style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em; font-weight: bold;" colspan="3" align="left">Table Links</th>
        </tr>
      </thead>
      <tbody>
        <xsl:for-each select="//table-wrap">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="tblId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::book-part-wrapper/descendant::xref/@rid=$tblId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::book-part-wrapper/descendant::xref[@rid=$tblId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::book-part-wrapper/descendant::xref/@rid=$tblId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$tblId"/>
                  </span>
    ...
    <table style="border: 1px solid black;margin-top:24pt;" width="33%">
      <thead>
        <tr>
          <th style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em; font-weight: bold;" colspan="3" align="left">Foot Note Links</th>
        </tr>
      </thead>
      <tbody>
        <xsl:for-each select="//back/fn-group/fn">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="fnId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::book-part-wrapper/descendant::xref/@rid=$fnId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::book-part-wrapper/descendant::xref[@rid=$fnId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::book-part-wrapper/descendant::xref/@rid=$fnId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$fnId"/>
                  </span>
    ...
    <table style="border: 1px solid black;margin-top:24pt;margin-bottom:33pt;" width="33%">
      <thead>
        <tr>
          <th style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em; font-weight: bold;" colspan="3" align="left">Reference Links</th>
        </tr>
      </thead>
      <tbody>
        <xsl:for-each select="//back/ref-list/ref">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="refId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::book-part-wrapper/descendant::xref/@rid=$refId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::book-part-wrapper/descendant::xref[@rid=$refId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::book-part-wrapper/descendant::xref/@rid=$refId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$refId"/>
                  </span>
      ...
      <!--<p>
      <h3>Equation Links</h3>
    </p>
    <hr/>
    <xsl:for-each select="//disp-formula">
        <xsl:if test="boolean(./@id)">
        <xsl:variable name="disId" select="string(./@id)"/>
        <xsl:if test="boolean(ancestor::book-part-wrapper/descendant::xref/@rid=$disId)">
          [<span style="color:blue;">
            <xsl:value-of select="$disId"/>
          </span>];&#x00A0;&#x00A0;
        </xsl:if>
        <xsl:if test="not(ancestor::book-part-wrapper/descendant::xref/@rid=$disId)">
          [<span style="color:red;">
            <xsl:value-of select="$disId"/>
          </span>];&#x00A0;&#x00A0;
        </xsl:if>
    ...
    <xsl:template match="book-part-meta/title-group/title">
    <h1 class="document-title">
      <xsl:apply-templates/>
    </h1>
  </xsl:template>

  <xsl:template match="book-part-meta/contrib-group">
  ...
  <xsl:template match="book-part-meta/pub-date">
    <p>
      <span style="font-weight:bold;">PUB Date: </span>
      <xsl:apply-templates/>
    </p>
  </xsl:template>
  ...
  <xsl:template match="book-part-meta/fpage">
    <p>
      <span style="font-weight:bold;">FPage: </span>
      <xsl:apply-templates/>
    </p>
  </xsl:template>
  ...
  <xsl:template match="book-part-meta/lpage">
    <p>
      <span style="font-weight:bold;">LPage: </span>
      <xsl:apply-templates/>
    </p>
  </xsl:template>

  <xsl:template match="book-part-meta/alternate-form">
    <p>
      <span style="font-weight:bold;">Alternate Form: </span>
      <a href="{@xlink:href}">
        <u>
  ...
  <xsl:template match="book-part-meta/counts/page-count">
    <p>
      <span style="font-weight:bold;">Page Count: </span>
  ...
  <xsl:template match="body">
    <xsl:if test="boolean(ancestor::body)">
      <div style="background-color:#CEE3F6;">
        <xsl:apply-templates/>
      </div>
    </xsl:if>
      <xsl:if test="not(ancestor::body)">
...
<!-- ============================================================= -->
  ...
  <xsl:template name="make-article">
    ...
    <div id="{$this-article}-front" class="front" style="background-color:#F8E0E0">
      <xsl:apply-templates select="front | front-stub"/>
    </div>

    <!-- body -->
    <xsl:for-each select="body">
      <div id="{$this-article}-body" class="body" style="background-color:#CEE3F6;">
        <xsl:apply-templates/>
      </div>
    </xsl:for-each>
  ...
  <xsl:template match="front | front-stub">
    ...
    <div class="metadata two-column table" style="background-color:lightblue;">
      <div class="row">
      ...
      <tbody>
        <xsl:for-each select="//fig">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="figId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::article/descendant::xref/@rid=$figId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                    <xsl:value-of select="$figId"/>
                  </span>
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::article/descendant::xref[@rid=$figId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::article/descendant::xref/@rid=$figId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$figId"/>
                  </span>
      ...
      <tbody>
        <xsl:for-each select="//table-wrap">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="tblId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::article/descendant::xref/@rid=$tblId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                    <xsl:value-of select="$tblId"/>
                  </span>
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::article/descendant::xref[@rid=$tblId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::article/descendant::xref/@rid=$tblId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$tblId"/>
                  </span>
      ...
      <tbody>
        <xsl:for-each select="//back/fn-group/fn">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="fnId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::article/descendant::xref/@rid=$fnId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                    <xsl:value-of select="$fnId"/>
                  </span>
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::article/descendant::xref[@rid=$fnId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::article/descendant::xref/@rid=$fnId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$fnId"/>
                  </span>
      ...
      <tbody>
        <xsl:for-each select="//back/ref-list/ref">
          <xsl:if test="boolean(./@id)">
            <tr>
              <xsl:variable name="refId" select="string(./@id)"/>
              <xsl:if test="boolean(ancestor::article/descendant::xref/@rid=$refId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:blue;">
                    <xsl:value-of select="$refId"/>
                  </span>
                ...
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="20%">
                  <span style="color:blue;">xref:&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(ancestor::article/descendant::xref[@rid=$refId])"/>
                  <br/>
                  <span style="color:blue;">label:&#x00A0;&#x00A0;&#x00A0;&#x00A0;</span>
                  <xsl:value-of select="string(child::label)"/>
                </td>
              </xsl:if>
              <xsl:if test="not(ancestor::article/descendant::xref/@rid=$refId)">
                <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em;" width="13%">
                  <span style="color:red;">
                    <xsl:value-of select="$refId"/>
                  </span>
    ...
    <xsl:for-each select="//disp-formula">
        <xsl:if test="boolean(./@id)">
        <xsl:variable name="disId" select="string(./@id)"/>
        <xsl:if test="boolean(ancestor::article/descendant::xref/@rid=$disId)">
          [<span style="color:blue;">
            <xsl:value-of select="$disId"/>
          </span>];&#x00A0;&#x00A0;
        </xsl:if>
        <xsl:if test="not(ancestor::article/descendant::xref/@rid=$disId)">
          [<span style="color:red;">
            <xsl:value-of select="$disId"/>
          </span>];&#x00A0;&#x00A0;
        </xsl:if>
    ...
    <hr/>-->
      ...
      <xsl:for-each select="article-meta | self::front-stub">
        ...
        <xsl:if test="aff-alternatives | author-notes">
          <div class="section" style="text-align:center;font-size:80%">
            ...
            <div class="cell">
              <div class="metadata-group">-->
                <xsl:apply-templates mode="metadata"
                  select="aff-alternatives | author-notes"/>
              <!--</div>
            </div>
            </div>-->
          ...
          <xsl:for-each select="abstract | trans-abstract">
            ...
            <div class="section">
              ...
              <!--<div class="cell" style="text-align: left">-->
                <h4 class="callout-title" style="text-align:center">
        ...
        <div class="metadata">
            <xsl:apply-templates mode="metadata" select="kwd-group"/>
        </div>
       ...
       <hr class="part-rule"/>
        <div class="metadata">
            ...
            <div class="metadata-group">
              ...
              <xsl:apply-templates mode="metadata"
                select="article-categories | counts"/>
...
<xsl:for-each select="contrib">
<div class="section" style="text-align:center;font-size:90%">
<xsl:call-template name="contrib-identify">
</xsl:call-template>
<xsl:call-template name="contrib-info">
</xsl:call-template>
...
<xsl:apply-templates select="."/>
  ...
  <xsl:template match="xref" mode="metadata-inline">
    ...
    <xsl:apply-templates select="."/>
    <span class="generated">]</span>
    Modified due to Extra Square Bracket == Kolappa (6-Jul-2015)
    -->
      <xsl:apply-templates select="."/>
  </xsl:template>
  ...
  <xsl:template name="contrib-info">
    ...
    <div class="metadata-group">
      ...
      <xsl:apply-templates mode="metadata"
        select="address | author-comment | bio | email |
                ext-link | on-behalf-of | role | uri"/>
    </div>
  </xsl:template>
  ...
  <xsl:template match="kwd-group" mode="metadata">
    <xsl:call-template name="metadata-area">
      <xsl:with-param name="label">
        ...
        <xsl:apply-templates select="label" mode="metadata-inline"/>
      </xsl:with-param>
            <xsl:with-param name="contents">
        <xsl:apply-templates mode="metadata"/>
      </xsl:with-param>
  ...
  <xsl:template match="kwd" mode="metadata">
    ...
    <xsl:apply-templates/>
    <xsl:if test="boolean(following-sibling::kwd)">
      <xsl:text>;&#xA0;&#xA0;&#xA0;</xsl:text>
   </xsl:if>
    </span>
  <!--  <xsl:template match="kwd" mode="metadata">
  ...
  <xsl:template match="body/sec/sec/sec/sec/sec/p">
    <p style="text-align:left">
      <xsl:apply-templates/>
    </p>
  </xsl:template>
  ...
  <xsl:template name="main-title"
    ...
    <xsl:if test="normalize-space(string($contents))">
      ...
      <h2 class="main-title" style="text-align:left">
        <span style="border:solid;color:black;background-color:white;">
          &#x00A0;H1
        </span>&#x00A0;
...
<!-- ============================================================= -->
  ...
  <xsl:template match="caption">
    <xsl:if test="boolean(ancestor::table-wrap)">
  ...
  <xsl:template match="fig/caption">
      <span class="figure-caption" style="margin-bottom:3mm;">
      <xsl:apply-templates/> 
      </span>
  </xsl:template>
  ...
  <xsl:template match="disp-formula">
    ...
    <span class="{local-name()}">
      ...
      <span class="mquote">
        <!--<xsl:value-of select="descendant::label[1]"/>-->
      </span>
      <xsl:apply-templates/>
      <!--<img>
        <xsl:attribute name="alt">
          <xsl:text>images/dismath</xsl:text>
          <xsl:value-of select="count(preceding::disp-formula) + 1"/>
  ...
  <xsl:template match="graphic">
    <xsl:apply-templates/>
	<span style="display:block;margin-top:6mm;">
    <img alt="{@xlink:href}" style="max-width:50%;" src="../FigureImages/{@xlink:href}">
  ...
  <xsl:template match="alt-text">
   ...
   <xsl:template match="list">
    <!--<span class="list">-->
     <br/>
     <span style="float:left;border:solid;padding:3px;background-color:white;">
       list-type =
...
<ul style="list-style-type: none">
  ...
  <xsl:template match="p | license-p">
      <xsl:choose>
        <xsl:when test="boolean(descendant::list)">
          <div>
  ...
  <xsl:template match="chem-struct/label |
  ...
  <xsl:template match="app/label | boxed-text/label |
    chem-struct-wrap/label | chem-struct-wrapper/label |
    disp-formula/label | fn/label | ref/label |
    statement/label | supplementary-material/label"
  priority="2">
    <!-- suppressed, since acquired by their parents in mode="label" -->
  </xsl:template>
  ...
  <xsl:template match="fig/label">
    <span class="label" style="font-size:90%">
      <xsl:apply-templates/>&#160;
    </span>
  </xsl:template>
  ...
  <xsl:template match="table-wrap/oasis:table">
    <xsl:for-each select=".">
    <p class="table-id">
      <xsl:call-template name="named-anchor"/>
    </p>
    <table align="center" class="table-code" style="border: 1px solid black;text-align:center;">
      <xsl:apply-templates/>
    </table>
    <!--<p>
      <img>
        <xsl:attribute name="alt">
          <xsl:text>images/table</xsl:text>
  ...
  <xsl:template match="oasis:entry">
    <xsl:if test="boolean(ancestor::oasis:thead)">
      <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em; font-weight: bold;">
        <xsl:if test="./@namest">
          <xsl:variable name="namest" select="substring-after(@namest,'col')"/>
          <xsl:variable name="nameend" select="substring-after(@nameend,'col')"/>
          <!--<xsl:variable name="namestPos" select="count(ancestor::oasis:tgroup/oasis:colspec[@colname=$namest]/preceding-sibling::oasis:colspec)"/>-->
		  <xsl:variable name="namestPos" select="@namest"/>
		  <!--<xsl:variable name="nameendPos" select="count(ancestor::oasis:tgroup/oasis:colspec[@colname=$nameend]/preceding-sibling::oasis:colspec)"/>-->
          <xsl:variable name="nameendPos" select="@nameend"/>
    ...
    <xsl:if test="not(ancestor::oasis:thead)">
      <td style="border: 1px solid black; padding-left: 0.25em; padding-right: 0.25em">
        <xsl:if test="./@namest">
          <xsl:variable name="namest" select="substring-after(@namest,'col')"/>
          <xsl:variable name="nameend" select="substring-after(@nameend,'col')"/>
          <!--<xsl:variable name="namestPos" select="count(ancestor::oasis:tgroup/oasis:colspec[@colname=$namest]/preceding-sibling::oasis:colspec)"/>-->
  ...
  <xsl:template match="x">
    <xsl:if test="contains(text(),'page')">
  ...
  <xsl:template match="inline-formula">
    <xsl:for-each select=".">
      <span class="{local-name()}">
        ...
        <!--<img>
          <xsl:attribute name="alt">
            <xsl:text>images/inmath</xsl:text>
            <xsl:value-of select="count(preceding::inline-formula) + 1"/>
            <xsl:text>.jpeg</xsl:text>
          </xsl:attribute>
          <xsl:attribute name="src">
            <xsl:text>images/inmath</xsl:text>
  ...
  <xsl:template match="named-content">
    <xsl:if test="boolean(./@content-type='online')">
    </xsl:if>
    <xsl:if test="not(./@content-type='online')">
      <span>
        <xsl:for-each select="@content-type">
          <xsl:attribute name="class">
            <xsl:value-of select="translate(.,' ','-')"/>
  ...
  <xsl:template match="italic">
    <i>
      <span style="background-color:#F5A9A9">
        <xsl:apply-templates/>
      </span>
    </i>
  </xsl:template>
  ...
  <xsl:template match="ack">
    <xsl:call-template name="backmatter-section">
      <xsl:with-param name="generated-title"></xsl:with-param>
    </xsl:call-template>
  </xsl:template>
  ...
  <xsl:template match="back/bio">
    <xsl:if test="not(preceding-sibling::bio)">
      <xsl:call-template name="backmatter-section">
        <xsl:with-param name="generated-title">Biography</xsl:with-param>
      </xsl:call-template>
    </xsl:if>
    <xsl:if test="preceding-sibling::bio">
      <xsl:call-template name="backmatter-section">
        <!--<xsl:with-param name="generated-title">Biography</xsl:with-param>-->
      </xsl:call-template>
    </xsl:if>
...
-->  
  ...
  <xsl:template mode="label" match="*" name="block-label">
    ...
    <xsl:if test="normalize-space(string($contents))">
      ...
      <h5 class="label">
        <xsl:if test="not(contains($contents,'('))">
            <!--<xsl:copy-of select="$contents"/>-->
        </xsl:if>
...
<!-- ============================================================= -->
  ...
  <xsl:template match="name">
    ...
    <xsl:if test="boolean(ancestor::ref)">
      <xsl:if test="count(following-sibling::name)=1">
  ...
  <xsl:template match="contrib/name/surname" mode="inline-name">
    <font style="background-color: #a176a1"><xsl:apply-templates/></font>
  ...
  <!--<xsl:template match="contrib/role" mode="inline-name">
    <xsl:value-of select="."/>
  </xsl:template>-->
  ...
  <xsl:template name="metadata-labeled-entry">
    ...
    <xsl:call-template name="metadata-entry">
      <xsl:with-param name="contents">
        <xsl:if test="normalize-space(string($label))">
          <xsl:choose>
            <xsl:when test="$label = 'Keywords'">
            </xsl:when>
            <xsl:when test="$label = 'Keyword'">
            </xsl:when>
            <xsl:otherwise>
              <span class="generated">
                <xsl:copy-of select="$label"/>
...
<!-- ============================================================= -->
  ...
  <xsl:template name="author-string">
    <!--ashok<xsl:variable name="all-contribs"
...
<!--  <xsl:template name="report-warning">
  ...
  <xsl:template match="//mixed-citation[@publication-type='book']">
    <p>
  ...
  <xsl:template match="//mixed-citation[@publication-type='journal']">
    <p>
      <font color="blue">Journal:</font>
      <br/>
      <xsl:apply-templates/>
      <hr/>
    </p>
  </xsl:template>
  <xsl:template match="//mixed-citation[@publication-type='conf-proc']">
    <p>
      <font color="gray">conf-proc: </font>
      <br/>
      <xsl:apply-templates/>
      <hr/>
    </p>
  </xsl:template>
  <xsl:template match="//mixed-citation[@publication-type='web']">
    <p>
      <font color="blue">Web: </font>
      <br/>
      <xsl:apply-templates/>
      <hr/>
    </p>
  </xsl:template>
  <xsl:template match="//mixed-citation[@publication-type='report']">
    <p>
  ...
  <xsl:template match="//mixed-citation[@publication-type='thesis']">
    <p>
      <font style="color: red">Thesis: </font>
      <br/>
        <xsl:apply-templates/>
    </p>
  </xsl:template>
  <xsl:template match="//mixed-citation[@publication-type='paper']">
    <p>
<font style="color: violet">Paper: </font>
      <br/>
        <xsl:apply-templates/>
    </p>
  </xsl:template>
  <xsl:template match="//mixed-citation[@publication-type='other']">
    <p>
  ...
  <xsl:template match="//string-name">
    <font style="border:1pt solid black;">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//given-names">
    <font style="color: blue; background-color: orange">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  ...
  <xsl:template match="//chapter-title">
    <font style="color: black; background-color: lightgreen">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//conf-name">
    <font style="color: black; background-color: LightSlateGray">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  ...
  <xsl:template match="//conf-loc">
    <font style="color: black; background-color: DarkViolet">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//article-title">
    <font style="color: black; background-color: DodgerBlue">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//subtitle">
    <br/>
    <font style="color: red; font-size:15pt;text-align:center">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//publisher-loc">
    &#160;<font style="color: fff; background-color: #008080">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//publisher-name">
    &#160;<font style="color: fff; background-color: #757139">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//year">
    <font style="color: fff; background-color: brown">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//ref/*/fpage">
    <font style="color: black; background-color: orange">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//ref/*/lpage">
    <font style="color: fff; background-color: DeepPink">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//comment">
    <font style="color: black; background-color: DarkSalmon">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//volume">
    &#160;<font style="color: yellow; background-color: Green">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//issue">
    <font style="color: orange; background-color: DarkOliveGreen">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//month">
    <font style="color: red; background-color: fff">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//day">
    <font color="LightGoldenRod">
      <xsl:apply-templates/>
    </font>
  </xsl:template>

  <xsl:template match="//season">
    <font style="color: yellow; background-color: gray">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//suffix">
    <font style="color: red; background-color: gray">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  ...
  <xsl:template match="//trans-title">
    <font style="color: yellow; background-color: lightblue">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//trans-source">
    <font style="color: green; background-color: yellow">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
  <xsl:template match="//pub-id">
    <font style="color: green; background-color: lightgray">
      <xsl:apply-templates/>
    </font>
  </xsl:template>
